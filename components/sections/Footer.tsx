  ...
  return (
    <footer
      ...
      style={{
        ...
        padding: 'clamp(72px,10vw,120px) clamp(20px,5vw,64px) 56px',
      }}
    >
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        <Reveal delay={80}>
          ...
          >
            ...
            <WBtn variant="ghost" onClick={onComunidad}>
        ...
        >
          <Reveal>
            ...
            >
              ¿Quieres participar, proponer un tema o colaborar? Mándanos un mensaje y te
              respondemos pronto.
            </p>
            <a
