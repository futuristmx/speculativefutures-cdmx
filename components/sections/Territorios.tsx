...
const TERR_DEFS: [string, string][] = [
  ...
  [
    'Innovación & Negocios',
    'Modelos y economías que emergen cuando algo empieza a cambiar.',
  ],
  [
    'Ciudad & Sistemas Vivos',
    'Lo urbano leído como sistema que se adapta y se tensiona.',
  ],
  [
    'Cultura & Sociedad',
    'Cómo se mueven los imaginarios, los rituales y la pertenencia.',
  ],
  [
    'Tecnologías Emergentes',
    'Lo técnico entendido desde su contexto y sus consecuencias.',
  ],
];
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <Reveal>
          <Eyebrow ix="02" label="Cinco territorios" />
        </Reveal>
        <Reveal
          as="h2"
          delay={60}
        ...
        >
          Una taxonomía fija. Cada señal, voz y evento se ancla a uno de estos cinco
          territorios.
        </Reveal>
