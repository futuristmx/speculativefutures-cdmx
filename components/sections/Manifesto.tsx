...
const lines: [string, string, string][] = [
  [
    'La especulación responsable observa la realidad con profundidad, reconoce sus tensiones y explora posibilidades con ',
    'consecuencias',
    '.',
  ],
  [
    'Creemos en la imaginación como ',
    'infraestructura',
    ': estratégica, cultural y cívica.',
  ],
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <Reveal>
          <Eyebrow ix="03" label="Manifiesto" />
        </Reveal>
        <div style={{ marginTop: 40, display: 'flex', flexDirection: 'column', gap: 36 }}>
          {lines.map((l, i) => (
            ...
            >
              {l[0]}
              <span style={{ color: C.MINT }}>{l[1]}</span>
              {l[2]}
            </Reveal>
          ))}
        </div>
