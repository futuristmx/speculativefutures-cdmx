  ...
  return (
    <Overlay onClose={onClose} width={440}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 22 }}>
        <WIsotype size={46} />
        <span style={{ ...meta, color: C.PETROL, background: C.MINT, padding: '6px 12px', borderRadius: 999, fontSize: 11 }}>
          Próximamente
        </span>
      </div>
      ...
      <p style={{ fontFamily: FONT, fontWeight: 500, fontSize: 15, lineHeight: 1.55, color: C.BODY, margin: '0 0 26px' }}>
        La plataforma de la comunidad —señales, perfiles y conversaciones— abre pronto. El acceso aún no está disponible.
      </p>
      ...
      <div aria-hidden="true" style={{ opacity: .55, pointerEvents: 'none', userSelect: 'none' }}>
        ...
        <label style={{ ...meta, color: C.BODY, display: 'block', marginBottom: 8 }}>Contraseña</label>
        <input disabled type="password" placeholder="••••••••" style={{ ...fieldStyle, marginBottom: 22 }} />
        <div style={{ fontFamily: FONT, fontWeight: 500, fontSize: 15, padding: '13px 26px', borderRadius: 4, background: C.PETROL7, color: C.SLATE, textAlign: 'center' }}>
          Entrar
        </div>
      </div>
