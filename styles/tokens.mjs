...
//
// JS plano para que lo consuman SIN flags tanto el código (vía tokens.ts, que
// re-exporta este archivo) como el generador de CSS (scripts/build-tokens.mjs).
// Las variables CSS (:root { --sf-* }) se generan con `npm run tokens:build`,
// que escribe styles/tokens.css. No editar tokens.css a mano.
// =============================================================================
...
// Mapeo token → variable CSS (lo consume el generador).
